...
<div class="container">
    ...
    <div class="login-wrap">
        <?= $form->field($model, 'username', ['template' => '<div class="form-group field-loginform-username required">{input}{hint}{error}</div>'])->textInput(['autofocus' => true, 'placeholder' => '用户名']) ?>
